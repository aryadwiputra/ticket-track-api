...
class StoreTicketRequest extends FormRequest
{
    ...
    {
        // Assuming any authenticated user with 'tickets-create' permission can create a ticket
        return auth()->check();
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'priority' => ['nullable', 'string', Rule::in(TicketPriorityEnum::values())],
            'assigned_to_user_id' => ['nullable', 'exists:users,id'],
            // created_by_user_id will be set automatically in the service/controller
        ];
    }
